...
function nameRequest(){
  visitorName = prompt('WELCOME visitor! What is your name?');
  alert('Thank you for visiting ' + visitorName + '. We will get to know each other more!');
}
function breakReadyQuestion(){
